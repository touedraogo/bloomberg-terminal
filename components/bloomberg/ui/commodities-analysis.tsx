  ...
  return (
    <div className="p-4 border rounded-sm mt-4" style={{ borderColor: colors.border, backgroundColor: colors.surface }}>
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-sm font-bold">AI COMMODITIES ANALYSIS</h3>
        <div className="flex gap-2">
          <BloombergButton color="accent" onClick={analyzeCommodities} disabled={isLoading} className="flex items-center gap-1 text-xs">
      ...
      <div className="p-3 mb-4 border rounded-sm text-xs" style={{ borderColor: colors.border, backgroundColor: colors.background, minHeight: "80px" }}>
        {isLoading && messages.length === 0 ? (
          ...
          <p className="text-gray-500">Cliquez ANALYSE pour une analyse du marché des matières premières.</p>
        )}
      </div>
